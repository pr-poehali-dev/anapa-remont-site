  ...
  const portfolioItems = [
    {
      ...
      image: "https://cdn.poehali.dev/files/691e5f93-3eb2-4ddf-a385-98603819f5f4.jpeg",
      description: "Минималистичная спальня в темных тонах с дизайнерским освещением"
    },
    {
      id: 2,
